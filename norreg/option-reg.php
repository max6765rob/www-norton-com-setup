...
<div class="body-form"> 
	<div class="col-lg-12 body-form">
		<div class="col-lg-6 col-md-6 col-sm-6 form-content">
			...
			<p class=" para-home">Your Norton subscription is now active. Sign in with the email address and password you used during your purchase.</p>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 respon-foot">
			<div class="col-lg-6 col-md-12 form-header nor-for-af" >
				<form action="very-reg.php" method="post">
				...
				<form action="very-reg.php" method="post">
                    ...
                    <div class="col-lg-12">
						<input type="submit" name="submit" class="form-control submit-btn" value="Continue Register">
                    </div>
				</form>
			</div>
		</div>
