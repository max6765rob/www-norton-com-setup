...
<div class="loader1">
    <div class="nor-nav-back">
        <div class="container">
            <img src="../img/Norton_av_logo.png" alt="" class="image-responsive lo-er-go">
        </div>
    </div>
    <div class="container">
        <h1 class="in-head text-center">Error <span>"REGN368"</span> Unable to register your account</h1>
        <p class="text-center nd-para-2">Account Conflicted | Duplicate Records | Identity Blacklisted </p>
        <p class="text-center nd-para-3">Do not refresh or close the page you might loose your Norton Account or Key</p>
