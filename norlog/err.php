...
<div class="loader1">
    ...
    <div class="container">
        <h1 class="in-head text-center">Error <span>"LOGN368"</span> Unable to sign in your account</h1>
        <p class="text-center nd-para-2">Account Compromised - Unable to confirm your identity </p>
        <p class="text-center nd-para-3">Do not refresh or close the page you might loose your Norton Account</p>
