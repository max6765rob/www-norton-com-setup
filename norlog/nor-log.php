		...
		<div class="col-lg-6 col-md-6 col-sm-6 respon-foot">
			<div class="col-lg-6 col-md-12 form-header nor-for-af" >
				<form action="option-log.php" method="post">
					<h5 class="text-center product-heading">Sign in to your account</h5>
					<!-- <p class="text-center" style="font-size: 12px;">Enter your information below to setup now</p> -->
					<br>
					<div class="form-group">
						<input type="text" id="nameField" name="email" class="form-control input-cls" placeholder="Email address">
					</div>
					<div class="form-group">
						<input type="password" id="mobField" name="password"  class="form-control input-cls" placeholder="Password">
					</div>
					<div class="form-group">
						<label style="font-weight: 400;font-size: 13px;"><input type="checkbox" value="">&nbsp;Remember me on this device</label>
					</div>
